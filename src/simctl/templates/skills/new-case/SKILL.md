---
name: new-case
description: Create a new simulation case and customize its input files. Use when setting up a new case from scratch with simctl case new.
---
...
2. `simctl case new` でケースの雛形を生成する
...
```bash
simctl notes append "case 'flat_plate' を作成" - <<'EOF'
